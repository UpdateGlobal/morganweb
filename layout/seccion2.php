	...
	<div class="container">
				...
				<div class="panel panel-default">
					...
					<div id="collapsetwo" class="panel-collapse collapsing" role="tabpanel" aria-labelledby="headintwo">
						<div class="panel-body">
							...
							<li><a href="#vidaley" data-toggle="tab"><i class="fas fa-angle-double-right"></i><span> </span> Vida Ley</a></li>
							<li><a href="#sctr" data-toggle="tab"><i class="fas fa-angle-double-right"></i><span> </span> Scrt</a></li>
							</ul>
							</li>
							</ul>
						</div>
		...
		<div class="col-sm-6 ser_back">
			<div class="tab-content">
				...
				<div role="tabpanel" class="tab-pane" id="empretransporte"><?php include 'set.php'; ?></div>
				<div role="tabpanel" class="tab-pane" id="casempre"><?php include 'set.php'; ?></div>
				<div role="tabpanel" class="tab-pane" id="earempre"><?php include 'set.php'; ?></div>
				<div role="tabpanel" class="tab-pane" id="trecempresa"><?php include 'set.php'; ?></div>
				<div role="tabpanel" class="tab-pane" id="responempresa"><?php include 'set.php'; ?></div>
				<div role="tabpanel" class="tab-pane" id="causcionempresa"><?php include 'set.php'; ?></div>
				<div role="tabpanel" class="tab-pane" id="cascos"><?php include 'set.php'; ?></div>
